...
sajat_df2.to_csv("d:/Egyetem/01Ma_Survey/Szakdolgozat/kod/Konye-MscCode/preprocessing_train_indep/02second_method/own_masodik.csv", index=False)

print("Saját cikkek kimentve")
print(sajat_df2.value_counts("label"))

### Model preparáló function ###
sajat_df2 = pd.read_csv("d:/Egyetem/01Ma_Survey/Szakdolgozat/kod/Konye-MscCode/preprocessing_train_indep/02second_method/own_masodik.csv")
...
# Tokenizer betöltése
with open('d:/Egyetem/01Ma_Survey/Szakdolgozat/kod/Konye-MscCode/preprocessing_train_indep/02second_method/tokenizer.pkl', 'rb') as f:
    tokenizer = pickle.load(f)

# Embedding mátrix betöltése
embedding_matrix = np.load('d:/Egyetem/01Ma_Survey/Szakdolgozat/kod/Konye-MscCode/preprocessing_train_indep/02second_method/embedding_matrix.npy')
...
# Mentés
np.save('d:/Egyetem/01Ma_Survey/Szakdolgozat/kod/Konye-MscCode/preprocessing_train_indep/02second_method/padded_sajat.npy', padded_sajat)
